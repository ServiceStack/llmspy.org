...
[![](./img/bg.webp)](https://servicestack.net/posts/llms-py-ui)

#### Dark Mode Support

[![](./img/dark-attach-image.webp?)](https://servicestack.net/posts/llms-py-ui)

#### Monthly Costs Analysis

[![](./img/analytics-costs.webp)](https://servicestack.net/posts/llms-py-ui)

#### Monthly Token Usage (Dark Mode)

[![](./img/dark-analytics-tokens.webp?)](https://servicestack.net/posts/llms-py-ui)

#### Monthly Activity Log

[![](./img/analytics-activity.webp)](https://servicestack.net/posts/llms-py-ui)
