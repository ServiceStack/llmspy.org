---
title: Agent Browser
description: A powerful new extension for building and running automated browser scripts in a a single workspace with AI assistance, live previews, debug log, and an interactive element inspector
---
